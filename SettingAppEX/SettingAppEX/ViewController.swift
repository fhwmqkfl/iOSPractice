...
class ViewController: UIViewController {
    ...
    let fourthValue: [(String, UIImage?)] = [("App Store", UIImage(systemName: "bluetooth")), ("지갑 및 Apple Pay", UIImage(systemName: "bluetooth"))]
    let fifthValue: [(String, UIImage?)] = [("암호", UIImage(systemName: "bluetooth")), ("연락처", UIImage(systemName: "bluetooth")), ("캘린더", UIImage(systemName: "bluetooth")), ("메모", UIImage(systemName: "bluetooth")), ("미리 알림", UIImage(systemName: "bluetooth")), ("전화", UIImage(systemName: "bluetooth")), ("메세지", UIImage(systemName: "bluetooth")), ("FaceTime", UIImage(systemName: "bluetooth"))]
    var settingList: [[(title: String, image: UIImage?)]] = []
